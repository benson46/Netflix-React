    ...
    return (
        <div className='navbar'>
            <div className="first-session">
                <div className='logo'>
                    <a href=""><NetflixLogo /></a>
                </div>
                <div className="buttons-navbar">
                    <a href="/" className="btn-header">Home</a>
                    <a href="/" className="btn-header">TV Shows</a>
                    <a href="/" className="btn-header">Movies</a>
                    <a href="/" className="btn-header">New & Popular</a>
                    <a href="/" className="btn-header">My List</a>
                    <a href="/" className="btn-header">Browse by Languages</a>
                </div>
            </div>
            <div className="second-section">
                <div className="ss-icons"><SearchIcon/></div>
                <div className="ss-icons"><Notification/></div>
                <div className="ss-icons"><Netflixavatar/></div>
            </div>
        </div>
    );
};
